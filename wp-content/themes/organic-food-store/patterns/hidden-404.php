...
<h3 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'Page not found', 'organic-food-store' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'It looks like nothing was found at this location. Click button below to return to homepage.', 'organic-food-store' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"10px"}}} -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/' ));?>" style="border-radius:10px"><?php echo esc_html__( 'Back to Home', 'organic-food-store' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
