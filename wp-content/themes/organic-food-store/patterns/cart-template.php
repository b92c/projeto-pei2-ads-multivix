...
/**
 * Title: Cart Template
 * Slug: organic-food-store/cart-template
...
<main class="wp-block-group has-secondary-bg-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:var(--wp--preset--spacing--40);padding-bottom:0;padding-left:var(--wp--preset--spacing--40)"><!-- wp:spacer -->
    ...
    <h1 class="wp-block-heading alignwide has-text-align-center" style="margin-top:0;margin-bottom:0;font-size:48px;line-height:1.2"><?php echo esc_html__( 'Cart', 'organic-food-store' ); ?></h1>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'You may be interested in', 'organic-food-store' ); ?>…</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php echo esc_html__( 'Your cart is currently empty!', 'organic-food-store' ); ?></h2>
    <!-- /wp:heading -->
    
    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center"><a href="#"><?php echo esc_html__( 'Browse store', 'organic-food-store' ); ?></a></p>
    <!-- /wp:paragraph -->
    ...
    <h2 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'New in store', 'organic-food-store' ); ?></h2>
    <!-- /wp:heading -->
