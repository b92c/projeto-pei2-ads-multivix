 ...
 * Slug: organic-food-store/search-template
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"organic-food-store","area":"uncategorized"} /--></div>
<!-- /wp:column -->
